...
for cond in conditions:
    ...
    plt.title(f"Std Dev of Weather Delays vs Time of Day\nWeather Condition: {cond}", fontsize=16)
    plt.xlabel("Scheduled Departure Time", fontsize=14)
    plt.ylabel("Std Dev of Weather Delay (minutes)", fontsize=14)
